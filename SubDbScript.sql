USE [master]
GO
/****** Object:  Database [#NAMEDATA]    Script Date: 08/03/2026 11:20:50 طµ ******/
CREATE DATABASE [#NAMEDATA]
CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'MEDADSOFT', FILENAME = N'#DATAPATH' , SIZE = 21952KB , MAXSIZE = UNLIMITED, FILEGROWTH = 15%)
 LOG ON 
( NAME = N'MEDADSOFT_LOG', FILENAME = N'#DATAPATH' , SIZE = 5056KB , MAXSIZE = 2048GB , FILEGROWTH = 15%)
GO
ALTER DATABASE [#NAMEDATA] SET COMPATIBILITY_LEVEL = 100
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [#NAMEDATA].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [#NAMEDATA] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [#NAMEDATA] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [#NAMEDATA] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [#NAMEDATA] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [#NAMEDATA] SET ARITHABORT OFF 
GO
ALTER DATABASE [#NAMEDATA] SET AUTO_CLOSE ON 
GO
ALTER DATABASE [#NAMEDATA] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [#NAMEDATA] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [#NAMEDATA] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [#NAMEDATA] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [#NAMEDATA] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [#NAMEDATA] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [#NAMEDATA] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [#NAMEDATA] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [#NAMEDATA] SET  DISABLE_BROKER 
GO
ALTER DATABASE [#NAMEDATA] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [#NAMEDATA] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [#NAMEDATA] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [#NAMEDATA] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [#NAMEDATA] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [#NAMEDATA] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [#NAMEDATA] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [#NAMEDATA] SET RECOVERY FULL 
GO
ALTER DATABASE [#NAMEDATA] SET  MULTI_USER 
GO
ALTER DATABASE [#NAMEDATA] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [#NAMEDATA] SET DB_CHAINING OFF 
GO
ALTER DATABASE [#NAMEDATA] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [#NAMEDATA] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
ALTER DATABASE [#NAMEDATA] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [#NAMEDATA] COLLATE Arabic_CI_AS 
GO
USE [#NAMEDATA]
GO
...
USE [master]
GO
ALTER DATABASE [#NAMEDATA] SET  READ_WRITE 
GO
